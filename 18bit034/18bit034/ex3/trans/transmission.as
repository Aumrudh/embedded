...
;; *************** function _main *****************
;; Defined at:
;;		line 2 in file "D:\18bit034\ex3\trans\trans.c"
...
psect	text0
psect	text0
	file	"D:\18bit034\ex3\trans\trans.c"
	line	2
...
l611:
;trans.c: 3: TXSTA=0x20;
	movlw	low(020h)
	movwf	((c:4012)),c	;volatile
	line	4
;trans.c: 4: RCSTA=0x90;
	movlw	low(090h)
...
l29:
	line	12
;trans.c: 12: TXREG=PORTA;
	movff	(c:3968),(c:4013)	;volatile
	goto	l24
	line	13
