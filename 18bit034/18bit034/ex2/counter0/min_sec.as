...
;; *************** function _main *****************
;; Defined at:
;;		line 2 in file "D:\18bit034\ex2\counter0\min_sec.c"
...
psect	text0
psect	text0
	file	"D:\18bit034\ex2\counter0\min_sec.c"
	line	2
...
l606:
;min_sec.c: 6: T0CON=0x68;
	movlw	low(068h)
	movwf	((c:4053)),c	;volatile
	line	7
	
l608:
;min_sec.c: 7: TMR0L=0x00;
	movlw	low(0)
...
l610:
;min_sec.c: 9: TMR0ON=1;
	bsf	c:(32431/8),(32431)&7	;volatile
	line	10
;min_sec.c: 10: while(TMR0L!=60){
	goto	l612
	
l19:
	line	11
;min_sec.c: 11: PORTB=TMR0L;
	movff	(c:4054),(c:3969)	;volatile
	goto	l612
	line	12
...
l20:
	line	13
;min_sec.c: 12: }
;min_sec.c: 13: TMR0ON=0;
	bcf	c:(32431/8),(32431)&7	;volatile
	line	14
	
l614:
;min_sec.c: 14: TMR0L=0;
	movlw	low(0)
	movwf	((c:4054)),c	;volatile
	line	15
...
l618:
;min_sec.c: 16: PORTD=i;
	movff	(c:main@i),(c:3971)	;volatile
	goto	l610
	line	17
