...
;; *************** function _main *****************
;; Defined at:
;;		line 10 in file "D:\18bit034\ex2\timer3\square.c"
...
psect	text0
psect	text0
	file	"D:\18bit034\ex2\timer3\square.c"
	line	10
...
l1773:
;square.c: 11: TRISB5=0;
	bcf	c:(31901/8),(31901)&7	;volatile
	line	12
	
l1775:
;square.c: 12: T3CON=0x34;
	movlw	low(034h)
...
l1779:
;square.c: 15: RB5=~RB5;
	btg	c:(31757/8),(31757)&7	;volatile
	line	16
...
;; *************** function _delay *****************
;; Defined at:
;;		line 2 in file "D:\18bit034\ex2\timer3\square.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l605:
;square.c: 3: TMR3H=0xF3;
	movlw	low(0F3h)
	movwf	((c:4019)),c	;volatile
	line	4
;square.c: 4: TMR3L=0xCB;
	movlw	low(0CBh)
