...
;; *************** function _main *****************
;; Defined at:
;;		line 2 in file "C:\Users\imaum\Downloads\ex3\rece\reception.c"
...
psect	text0
psect	text0
	file	"C:\Users\imaum\Downloads\ex3\rece\reception.c"
	line	2
...
l604:
;reception.c: 3: TXSTA=0x00;
	movlw	low(0)
	movwf	((c:4012)),c	;volatile
	line	4
;reception.c: 4: RCSTA=0x90;
	movlw	low(090h)
	movwf	((c:4011)),c	;volatile
	line	5
;reception.c: 5: SPBRG=15;
	movlw	low(0Fh)
...
;reception.c: 6: RC7=1;
	...
	line	7
;reception.c: 7: TRISB=0;
	movlw	low(0)
	movwf	((c:3987)),c	;volatile
	goto	l20
	line	8
;reception.c: 8: while(1){
	
l19:
	line	9
;reception.c: 9: while(RCIF==0);
	goto	l20
...
l22:
	line	10
;reception.c: 10: PORTB=RCREG;
	movff	(c:4014),(c:3969)	;volatile
	goto	l20
	line	11
