...
;; *************** function _main *****************
;; Defined at:
;;		line 6 in file "D:\18bit034\ex1\pgm2\portbled.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  z               1    9[COMRAM] unsigned char 
...
psect	text0
psect	text0
	file	"D:\18bit034\ex1\pgm2\portbled.c"
	line	6
...
l1762:
;portbled.c: 7: TRISB=0;
	movlw	low(0)
	movwf	((c:3987)),c	;volatile
	line	9
	
l1764:
;portbled.c: 8: unsigned char z;
;portbled.c: 9: for(z=1;z<255;z++){
...
l13:
	line	10
;portbled.c: 10: PORTB=z;
	movff	(c:main@z),(c:3969)	;volatile
	line	11
	
l1770:
;portbled.c: 11: delay(15000);
	movlw	low(03A98h)
	movwf	((c:?_delay)),c
	movlw	high(03A98h)
	movwf	((c:?_delay+1)),c
	movlw	low highword(03A98h)
	movwf	((c:?_delay+2)),c
	movlw	high highword(03A98h)
	movwf	((c:?_delay+3)),c
...
;; *************** function _delay *****************
;; Defined at:
;;		line 2 in file "D:\18bit034\ex1\pgm2\portbled.c"
;; Parameters:    Size  Location     Type
;;  i               4    0[COMRAM] unsigned long 
;; Auto vars:     Size  Location     Type
;;  z               4    4[COMRAM] unsigned long 
;; Return value:  Size  Location     Type
;;		None               void
;; Registers used:
...
l594:
;portbled.c: 3: for(unsigned long z=0;z<i;z++){
	movlw	low(0)
	movwf	((c:delay@z)),c
	movlw	high(0)
	movwf	((c:delay@z+1)),c
...
l596:
	...
	addwf	((c:delay@z)),c
	movlw	0
	addwfc	((c:delay@z+1)),c
	movlw	0
	addwfc	((c:delay@z+2)),c
	movlw	0
	addwfc	((c:delay@z+3)),c
	
l7:
	movf	((c:delay@i)),c,w
	subwf	((c:delay@z)),c,w
	movf	((c:delay@i+1)),c,w
	subwfb	((c:delay@z+1)),c,w
	movf	((c:delay@i+2)),c,w
	subwfb	((c:delay@z+2)),c,w
	movf	((c:delay@i+3)),c,w
	subwfb	((c:delay@z+3)),c,w
	btfss	status,0
	goto	u11
	goto	u10
u11:
