...
;; *************** function _main *****************
;; Defined at:
;;		line 5 in file "D:\Aumrudh Documents\mepco\lab\sem6-Lab\embedded\even\embedded\StepperMotor\Dcc.c"
...
psect	text0
psect	text0
	file	"D:\Aumrudh Documents\mepco\lab\sem6-Lab\embedded\even\embedded\StepperMotor\Dcc.c"
	line	5
...
;; *************** function _delay *****************
;; Defined at:
;;		line 2 in file "D:\Aumrudh Documents\mepco\lab\sem6-Lab\embedded\even\embedded\StepperMotor\Dcc.c"
;; Parameters:    Size  Location     Type
...
l605:
;Dcc.c: 3: for(unsigned char i=0;i<a;i++){}
	movwf	(??_delay+0+0)&0ffh,c
	movlw	low(0)
	movwf	((c:delay@i)),c
	movf	(??_delay+0+0)&0ffh,c,w
	goto	l609
